...
export default function IndexPage(): JSX.Element {
  ...
  return (
    <Layout>
      ...
      {/* Begin Hero */}
      <div className="isolate bg-gray-100 dark:bg-black flex flex-col md:min-h-screen">
        <TopNavigationBar />
        ...
        <div className="flex-1 flex flex-col px-4 sm:px-6 lg:px-8 relative overflow-hidden">
